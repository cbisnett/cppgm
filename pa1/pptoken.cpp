...
int ValueToHexChar(int c)
{
    static char chars[] = "0123456789abcdef";

    if (c < 0 || c > 15)
        throw logic_error("ValueToHexChar of invalid value");
...
const unordered_set<u32string> Digraph_IdentifierLike_Operators =
{
...
// See C++ standard 2.13 Operators and punctuators
const unordered_set<u32string> Operators_Punctuators =
{
...
struct PPTokenizer
{
    ...
    string utf8Encode(const u32string &input)
    {
        string str;
